...
const ImageSearch = () => {
  ...
  const renderUploadBox = () => (
    ...
    >
      ...
      {!previewUrl ? (
        <>
          <span className="rounded-full bg-white/10 px-4 py-2 text-xs uppercase tracking-[0.4em] text-gray-700 dark:text-white/60">
            Upload image
          </span>
          <p className="text-xl font-semibold text-gray-900 dark:text-white">Drag or click</p>
        ...
        <div className="space-y-4">
          <p className="text-sm text-gray-700 dark:text-white/60">Selected image</p>
          <img
            src={previewUrl}
            alt="Preview"
  ...
  const renderResults = () => {
    if (loading) {
      return (
          ...
          <Loader />
          <p className="text-gray-600 dark:text-white/60">Searching...</p>
        </div>
      );
    }
    ...
    if (!searchResults.results || searchResults.results.length === 0) {
      return (
        <div className="glass-panel p-8 text-center text-gray-700 dark:text-white/70">
            ...
            >
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs uppercase tracking-wide text-gray-600 dark:text-white/50">
                    {result.category}
                  </span>
                </div>
                ...
                {result.price !== undefined && (
                  <p className="text-2xl font-semibold text-gray-900 dark:text-emerald-300">
