      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <form className="space-y-5" onSubmit={handleSubmit}>
          <div>
            ...
            <h2 className="mt-2 text-3xl font-display font-semibold text-white">
        ...
        <div className="space-y-6">
          <div className="glass-panel p-6">
            ...
            <p className={`mt-3 text-3xl font-semibold ${statusColor}`}>
              {statusLabel}
            </p>
            {result.is_genuine !== null && (
              <div className="mt-4 space-y-2 text-sm text-white/70">
                ...
                <p>
                  <span className="font-semibold text-white/90">Detected brand:</span>{" "}
                  {result.best_brand_match?.toUpperCase() || "N/A"}
                </p>
                <p>
                  <span className="font-semibold text-white/90">Confidence:</span>{" "}
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                {result.top_matches.map((match) => (
                  <div
                    ...
                    className="rounded-2xl border border-white/10 bg-white/5 p-3 text-center text-white"
                  >
                    <p className="text-sm font-semibold text-white/80">
                    ...
                    {match.reference_url && (
                      <img
                        ...
                        className="mt-2 h-24 w-full rounded-xl bg-white/5 object-contain"
                      />
                    )}
